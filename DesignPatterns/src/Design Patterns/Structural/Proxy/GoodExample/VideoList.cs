...
using DesignPatterns.src.DesignPatterns.Structural.Proxy.GoodExample.ThirdPartyVideoLib;

namespace DesignPatterns.src.DesignPatterns.Structural.Proxy.GoodExample
{
