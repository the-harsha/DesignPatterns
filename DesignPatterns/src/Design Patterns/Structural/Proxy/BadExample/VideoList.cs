...
using DesignPatterns.src.DesignPatterns.Structural.Proxy.BadExample.ThirdPartyVideoLib;

namespace DesignPatterns.src.DesignPatterns.Structural.Proxy.BadExample
{
