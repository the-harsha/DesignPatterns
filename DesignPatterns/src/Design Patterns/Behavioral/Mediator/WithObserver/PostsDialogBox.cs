...
using DesignPatterns.src.DesignPatterns.Behavioral.Mediator.WithObserver.UIFramework;


namespace DesignPatterns.src.DesignPatterns.Behavioral.Mediator.WithObserver
{
