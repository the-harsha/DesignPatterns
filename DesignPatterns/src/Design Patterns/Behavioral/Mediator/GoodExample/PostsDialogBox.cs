...
using DesignPatterns.src.DesignPatterns.Behavioral.Mediator.GoodExample.UIFramework;

namespace DesignPatterns.src.DesignPatterns.Behavioral.Mediator.GoodExample
{
